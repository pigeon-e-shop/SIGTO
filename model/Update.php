...
class Update
{
	...
	{
		$stmt = $this->conn->prepare("UPDATE articulo SET nombre=:nombre, precio=:precio, descripcion=:descripcion, rutaImagen=:rutaImagen, categoria=:categoria, descuento=:descuento, empresa=:empresa, stock=:stock, codigoBarra=:codigoBarra WHERE idArticulo=:id");
